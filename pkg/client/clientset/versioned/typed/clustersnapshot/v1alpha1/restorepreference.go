...
func (c *restorePreferences) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RestorePreference, err error) {
...
func (c *restorePreferences) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RestorePreferenceList, err error) {
...
func (c *restorePreferences) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *restorePreferences) Create(ctx context.Context, restorePreference *v1alpha1.RestorePreference, opts v1.CreateOptions) (result *v1alpha1.RestorePreference, err error) {
	result = &v1alpha1.RestorePreference{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("restorepreferences").
...
func (c *restorePreferences) Update(ctx context.Context, restorePreference *v1alpha1.RestorePreference, opts v1.UpdateOptions) (result *v1alpha1.RestorePreference, err error) {
	result = &v1alpha1.RestorePreference{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("restorepreferences").
...
func (c *restorePreferences) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *restorePreferences) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *restorePreferences) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RestorePreference, err error) {
	result = &v1alpha1.RestorePreference{}
