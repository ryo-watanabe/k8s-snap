...
import (
	v1alpha1 "github.com/ryo-watanabe/k8s-snap/pkg/client/clientset/versioned/typed/clustersnapshot/v1alpha1"
...
func (c *FakeClustersnapshotV1alpha1) Restores(namespace string) v1alpha1.RestoreInterface {
...
func (c *FakeClustersnapshotV1alpha1) Snapshots(namespace string) v1alpha1.SnapshotInterface {
