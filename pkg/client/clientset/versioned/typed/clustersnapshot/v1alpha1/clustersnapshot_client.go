...
import (
	...
	"github.com/ryo-watanabe/k8s-snap/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ClustersnapshotV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*ClustersnapshotV1alpha1Client, error) {
	...
	return &ClustersnapshotV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ClustersnapshotV1alpha1Client for the given config and
...
func New(c rest.Interface) *ClustersnapshotV1alpha1Client {
	return &ClustersnapshotV1alpha1Client{c}
}
...
func (c *ClustersnapshotV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
